...
String query = "UPDATE invoice_payment_history SET invoice_header_id=?, amount_paid=?, income=?, payment_method=?, updated_at=? WHERE id=?";
                try (PreparedStatement ps = con.prepareStatement(query)) {
                    ...
                    ps.setFloat(3, paymentHistory.getIncome());
                            ps.setString(4,paymentHistory.getPayment_method());
                    ps.setTimestamp(5, paymentHistory.getUpdatedAt());
                    ps.setInt(6, paymentHistory.getId());
                ...
                String query = "INSERT INTO invoice_payment_history (invoice_header_id, amount_paid, income,payment_method, created_at, updated_at) VALUES (?, ?, ?,?, ?, ?)";
                try (PreparedStatement ps = con.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
                    ps.setInt(1, paymentHistory.getInvoice_header_id());
                    ps.setFloat(2, paymentHistory.getAmount_paid());
                    ps.setFloat(3, paymentHistory.getIncome());
                    ps.setString(4,paymentHistory.getPayment_method());
                    ps.setTimestamp(5, paymentHistory.getCreatedAt());
                    ps.setTimestamp(6, paymentHistory.getUpdatedAt());
